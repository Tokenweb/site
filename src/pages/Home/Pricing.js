                        ...
                        <Row className="mt-lg-4 align-items-center">
                            <Col lg="5" md="12" className="text-center text-lg-left">
                                <div className="section-title mb-60">
                                    <h4 className="title mb-4">Our Funds</h4>
                                    <p className="text-muted para-desc mx-auto mb-0">We offer 3 tiers of funds all under a segregated portfolio company (SPC).
</p>
                                ...
                                <Row className="align-items-center ml-lg-5">
                                    <Col md="6" xs="12" className="pl-md-0 pr-md-0">
                                        <div className="pricing-rates starter-plan shadow bg-white pt-5 pb-5 p-4 rounded text-center">
                                            <h2 className="title text-uppercase text-primary mb-4">Token Fund I</h2>
                                            ...
                                            <ul className="feature list-unstyled pl-0">
                                                <li className="feature-list">Minimum Investment: $500</li>
                                                <li className="feature-list">Source Files</li>
                                    ...
                                    <Col md="6" xs="12" className="mt-4 pt-2 mt-sm-0 pt-sm-0 pl-md-0 pr-md-0">
                                        <div className="pricing-rates bg-light pt-5 pb-5 p-4 rounded text-center">
                                            <h2 className="title text-uppercase mb-4">Staking Fund I</h2>
                                            <div className="d-flex justify-content-center mb-4">
                                                <span className="h4 mb-0 mt-2">$</span>
