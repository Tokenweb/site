                                ...
                                <div className="mr-lg-3">
                                    <div className="blog position-relative overflow-hidden shadow rounded">
                                        ...
                                        <div className="content p-4">
                                            ...
                                            <p>However, we believe it is our responsibility to clearly share some high risks and potential long term unsustainable aspects of Filecoin which directly relates to mining risks so our clients can make informed decisions when allocating their capital.</p>
                                            ...
                                            Public websites and content such as image hosting websites, public data, static company websites and certain applications. Censor proof content sources such as distributed wikipedia powered by IPFS. Actually it is IPFS which is great for this but the issue with IPFS is speed, and Filecoin’s goal is an incentive layer to speed data retrieval up significantly. Time will tell how effective it is.</p>
                                            <p>We think decentralised storage is definitely something that will be common in the future, and we respect teams like Filecoin who take on the monumentos challenge of pushing it forward. It is just an uphill battle due to many technological limitations present in today’s world, but as it matures, Filecoin may become the de-facto protocol for data storage and retrieval. It is important to know the risks that an efficient and user friendly decentralised storage solution that is mass adopted may never happen before investing in a Filecoin mining operation. </p>


                                            <h6 className="text-muted">Now that you have a more clear understanding of the scope of Filecoin Mining and associated risks and limitations, if you decide mining Filecoin is right for you, we are happy to chat and create the perfect solution to achieve your goals. <a href="https://twitter.com/tokenweb_io" target="_blank">@tokenweb_io</a></h6>
