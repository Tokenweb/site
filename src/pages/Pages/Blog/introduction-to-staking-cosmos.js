                                ...
                                <div className="mr-lg-3">
                                    <div className="blog position-relative overflow-hidden shadow rounded">
                                        ...
                                        <div className="content p-4">
                                            ...
                                            <p className="text-muted">What happens next? On Lunio.io, you can monitor your staking rewards. You get paid out in ATOMs in real time. Once you have reached a certain amount of staking rewards, you can withdraw the sum and either re-stake it (reinvest for also being part of the staking mass) or pull it onto your ledger, send it to an exchange and cash it out into a fiat currency of your choice (Euro, Swiss Francs, US Dollar, your local currency. This is of course based on the availability of exchanges in your country.)</p>
